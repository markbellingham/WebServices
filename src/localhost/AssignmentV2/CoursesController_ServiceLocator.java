...
package localhost.AssignmentV2;

public class CoursesController_ServiceLocator extends org.apache.axis.client.Service implements localhost.AssignmentV2.CoursesController_Service {
    ...
    public localhost.AssignmentV2.CoursesController_PortType getCoursesControllerSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public localhost.AssignmentV2.CoursesController_PortType getCoursesControllerSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.AssignmentV2.CoursesControllerSOAPStub _stub = new localhost.AssignmentV2.CoursesControllerSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.AssignmentV2.CoursesController_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.AssignmentV2.CoursesControllerSOAPStub _stub = new localhost.AssignmentV2.CoursesControllerSOAPStub(new java.net.URL(CoursesControllerSOAP_address), this);
                _stub.setPortName(getCoursesControllerSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/AssignmentV2/", "CoursesController");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/AssignmentV2/", "CoursesControllerSOAP"));
        }
