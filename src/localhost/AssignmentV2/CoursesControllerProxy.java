...
public class CoursesControllerProxy implements localhost.AssignmentV2.CoursesController_PortType {
  private String _endpoint = null;
  private localhost.AssignmentV2.CoursesController_PortType coursesController_PortType = null;
  ...
  private void _initCoursesControllerProxy() {
    try {
      coursesController_PortType = (new localhost.AssignmentV2.CoursesController_ServiceLocator()).getCoursesControllerSOAP();
  ...
  public localhost.AssignmentV2.CoursesController_PortType getCoursesController_PortType() {
    if (coursesController_PortType == null)
      _initCoursesControllerProxy();
