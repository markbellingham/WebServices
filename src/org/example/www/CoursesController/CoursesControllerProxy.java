...
public class CoursesControllerProxy implements org.example.www.CoursesController.CoursesController_PortType {
  private String _endpoint = null;
  private org.example.www.CoursesController.CoursesController_PortType coursesController_PortType = null;
  ...
  private void _initCoursesControllerProxy() {
    try {
      coursesController_PortType = (new org.example.www.CoursesController.CoursesController_ServiceLocator()).getCoursesControllerSOAP();
  ...
  public org.example.www.CoursesController.CoursesController_PortType getCoursesController_PortType() {
    if (coursesController_PortType == null)
      _initCoursesControllerProxy();
